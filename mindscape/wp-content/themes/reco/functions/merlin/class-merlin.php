            ...
            <?php if ( ! $is_theme_registered ) : ?>
                <div class="merlin__content--license-email">
					<div class="merlin__content--license-email-wrapper">
                        <input type="email" id="license-email" class="js-license-email" autocomplete="on" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="Your email">
					</div>
				</div>
...
// var_dump($lb_activate_res);
//         exit;
//         // $response = $this->edd_get_api_response( $api_params );
//         $response = $this->verify_license( $license, $license_user );    

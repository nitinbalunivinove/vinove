...
$wizard = new Merlin(
	...
	$config = array(
		'directory'            => 'functions/merlin', // Location / directory where Merlin WP is placed in your theme.
		'merlin_url'           => 'estudiopatagon-wizard', // The wp-admin page slug where Merlin WP loads.
		...
		'edd_theme_slug'       => EPCL_THEMESLUG, // EDD_Theme_Updater_Admin item_slug.
        'ready_big_button_url' => admin_url('admin.php?page=estudiopatagon-welcome'), // Link for the big button on the ready step.
        'api_url'              => 'http://updates.estudiopatagon.com/',
        'child_theme_zip'      => 'wp-'.EPCL_THEMESLUG.'-child.zip'
	),
	$strings = array(
		...
		/* translators: Theme Name */
		'license%s'                => esc_html__( 'Enter your license key to enable one click updates and theme support.', '@@textdomain' ),
		...
		'ready%s'                  => esc_html__( 'Your theme has been all set up. Enjoy your new theme by EstudioPatagon', '@@textdomain' ),
		'ready-action-link'        => esc_html__( 'Extras', '@@textdomain' ),
		'ready-big-button'         => esc_html__( 'Go to the dashboard', '@@textdomain' ),
		'ready-link-1'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://wordpress.org/support/', esc_html__( 'Explore WordPress', '@@textdomain' ) ),
		'ready-link-2'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://estudiopatagon.ticksy.com/', esc_html__( 'Get Theme Support', '@@textdomain' ) ),
		'ready-link-3'             => sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'admin.php?page=ThemeOptionsPanel&tab=2' ), esc_html__( 'Start Customizing', '@@textdomain' ) ),
	)
);

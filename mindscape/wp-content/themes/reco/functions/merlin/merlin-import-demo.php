...
function prefix_merlin_local_import_files() {
	return array(
        array(
			...
			'import_notice'                => 'Before install Demo config, it is recommended to install our 3 required plugins (ACF, Redux and '.EPCL_THEMENAME.' Functions)',            
...
function prefix_merlin_after_import_setup() {
	...
	set_theme_mod(
		'nav_menu_locations', array(
            ...
            // 'epcl_footer' => $footer_menu->term_id,
		)
	);

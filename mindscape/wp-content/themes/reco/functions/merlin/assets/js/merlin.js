...
function ActivateLicense() {
        ...
        var wrapper_email = $( '.merlin__content--license-email' );
        var wrapper_user = $( '.merlin__content--license-user' );


        function ajax_callback(r) {

            if( !validateEmail( wrapper_email.find('input').val() || !wrapper_email.find('input').val() ) ){
                wrapper_email.addClass('has-error');
            }

            if( !wrapper_user.find('input').val() ){
                wrapper_user.addClass('has-error');
            }
        ...
        function do_ajax() {
            ...
            wrapper_user.removeClass('has-error');
            wrapper_email.removeClass('has-error');
            ...
            jQuery.post(merlin_params.ajaxurl, {
              ...
              license_email: $( '.js-license-email' ).val(),
              license_user: $( '.js-license-user' ).val()
            }, ajax_callback).fail(ajax_callback);

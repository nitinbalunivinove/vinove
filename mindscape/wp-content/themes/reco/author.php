...
<main id="archives" class="main grid-container">
    ...
    <?php if( empty($epcl_theme) || $epcl_theme['enable_global_counter'] == '1' ): ?>
        <div class="section grid-container">
            ...
            <h2 class="title ularge white textcenter no-margin"><?php esc_html_e('We found', 'reco'); ?> <span class="count main-color" data-total="<?php echo intval($wp_query->found_posts); ?>">0</span> <?php printf( esc_html_e( _n( 'article by this author...', 'articles by this author...', intval($wp_query->found_posts), 'reco' ), intval($wp_query->found_posts) ) ); ?></h2>
            <div class="clear"></div>
        </div>
    <?php endif; ?>

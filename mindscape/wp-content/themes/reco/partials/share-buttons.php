...
<div class="<?php echo esc_attr($wrapper_class); ?>">
    ...
    if( epcl_get_option('share_url_method', 'permalink') == 'shortlink' ){
...
onclick="window.open(this.href, 'twitter-share', 'width=550,height=235');return false;"><i class="fa fa-twitter"></i></a>
    ...
    <?php if( isset( $epcl_theme['enable_single_whatsapp'] ) && $epcl_theme['enable_single_whatsapp'] !== '0'): ?>    
        <a class="whatsapp hide-on-tablet <?php echo esc_attr($button_class); ?>" rel="nofollow noopener" href="https://api.whatsapp.com/send?text=<?php echo esc_url($share_url); ?>" data-action="share/whatsapp/share"><i class="fa fa-whatsapp"></i></a>    
    <?php endif; ?>
</div>
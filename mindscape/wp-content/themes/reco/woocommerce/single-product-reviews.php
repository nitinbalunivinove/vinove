		...
		<?php if ( have_comments() ) : ?>
			...
			<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
                    ...
                    <nav id="comment-nav" class="pagination section">
                        <div class="nav-previous alignleft"><?php previous_comments_link( esc_html__('Older Reviews', 'reco') ); ?></div>
                        <div class="nav-next alignright"><?php next_comments_link( esc_html__('Newer Reviews', 'reco') ); ?></div>
                        <div class="clear"></div>
                    </nav>
                    <!-- end: #comment-nav -->
			<?php endif; ?>
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				$comment_form = array(
					...
					'title_reply_before'  => '<span id="reply-title" class="comment-reply-title title medium half-margin">',

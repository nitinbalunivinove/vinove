...
<article <?php post_class('default index-'.$index.' '.$column_class.$post_class.' tablet-grid-50 np-mobile"'); ?>>
	...
	<header>
        ...
        <?php 
        /*
        if( !empty($epcl_theme) && $epcl_theme['enable_meta_data'] ): ?>
            <div class="meta">
    ...
    by <a href="<?php echo get_author_posts_url($author_id); ?>" title="<?php echo esc_attr($author_name); ?>"><?php echo esc_attr($author_name); ?></a>
